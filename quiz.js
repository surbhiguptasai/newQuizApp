var allQuestions = [
   ...
   
    {
        ...
        correctAnswer: "addClass( classes )"
    },
  ...
  
    {
        ...
        correctAnswer: "children([selector])"
    },
...

    {
...

     {
        ...
        correctAnswer: "isPropagationStopped()"
    },

     {
        ...
        correctAnswer: "ajaxSuccess(callback)"
    }
];
var submitBtn = $('#myBtn');
        ...
        for (var i = 0; i < radioButtons.length; i++) {
            var selection = radioButtons[i];
             if (selection.checked) {
                ...
                $('#answerMessage').html("<div class='red'> <img class='sadImage' src='http://clipart-library.com/data_images/71350.png'> Your answer is incorrect. Correct answer is "+ allQuestions[currentQuestion].correctAnswer +"</div>");
